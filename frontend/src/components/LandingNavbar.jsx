...
import { Hospital, LogIn, UserPlus, Menu } from "lucide-react";
...
export default function LandingNavbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Dropdown */}
      {menuOpen && (
        <div className="md:hidden fixed top-[64px] left-0 w-full bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 px-6 py-4 flex flex-col gap-3 shadow-lg z-40">
